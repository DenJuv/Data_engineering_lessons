...
sd = '2024-03-03'
ed = '2025-03-05'
URL = f'http://api.currencylayer.com/change?access_key={api_key}&currencies={curr}&start_date={sd}&end_date={ed}'
...
#print(dt)
print(result.get('start_date'))
print(result.get('end_date'))
